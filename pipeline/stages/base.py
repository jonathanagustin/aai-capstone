...
# CUSTOM SEQUENTIAL COLOR PALETTE
SEQUENTIAL_COLORS = ["#F8F9FA", "#4361EE"]  # LIGHT TO PRIMARY
...
def plot_decorator(func):
    """Decorator for plot buffer management."""
...
class PipelineStage(ABC):
    ...
    def __init__(self):
        ...
        # Set base style and backend settings
        ...
        sns.set_palette(self.cfg.visualization.palette)
    ...
    def plot_roc_curve(self, y_true, y_pred_proba, metrics, title="ROC Curve"):
        ...
        self.save_plot(
            "roc_curve",
            lambda data: (
                sns.lineplot(data=data, x="FPR", y="TPR", label=f'ROC curve (AUC = {metrics["roc_auc"]:.3f})'),
                sns.lineplot(x=[0, 1], y=[0, 1], linestyle="--", label="Random Chance"),
